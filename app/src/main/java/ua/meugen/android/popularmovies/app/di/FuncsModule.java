...
import ua.meugen.android.popularmovies.app.funcs.ModelToRequestFunc;
import ua.meugen.android.popularmovies.app.funcs.ResponseToModelFunc;
...
public class FuncsModule {
    ...
    @Provides @Singleton
    public Func1<JsonWritable, RequestBody> provideWritableRequestFunc(
